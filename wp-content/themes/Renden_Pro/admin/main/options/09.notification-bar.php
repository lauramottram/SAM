	...
	echo '<div id="notification"><div id="notification-core">';
		...
		if ( ! empty( $thinkup_notification_button ) ) {
					if ( $thinkup_notification_link == 'option1' and $thinkup_notification_linkpage !== 'Select a page:' ) {
						echo '<a href="' . get_permalink( $thinkup_notification_linkpage ) . '"><span class="notification-button">';
						echo $thinkup_notification_button;
						echo '</span></a>';
					} else if ( $thinkup_notification_link == 'option2' ) {
						echo '<a href="' . $thinkup_notification_linkcustom . '"><span class="notification-button">';
						echo $thinkup_notification_button;
						echo '</span></a>';
					} else {
