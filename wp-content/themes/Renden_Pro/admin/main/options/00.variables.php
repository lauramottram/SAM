...
function thinkup_reduxvariables() { 
	...
	$GLOBALS['thinkup_homepage_section4_imagesize']         = thinkup_var ( 'thinkup_homepage_section4_imagesize' );
	...
	$GLOBALS['thinkup_homepage_section4_url']               = thinkup_var ( 'thinkup_homepage_section4_url' );
	$GLOBALS['thinkup_homepage_section4_button']            = thinkup_var ( 'thinkup_homepage_section4_button' );
	$GLOBALS['thinkup_homepage_section4_target']            = thinkup_var ( 'thinkup_homepage_section4_target' );
	$GLOBALS['thinkup_homepage_introswitch']                = thinkup_var ( 'thinkup_homepage_introswitch' );
	$GLOBALS['thinkup_homepage_introaction']                = thinkup_var ( 'thinkup_homepage_introaction' );
	$GLOBALS['thinkup_homepage_introactionteaser']          = thinkup_var ( 'thinkup_homepage_introactionteaser' );
