...
$GLOBALS['thinkup_theme_version'] = '1.6.7';
...
if ( ! defined( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN' ) ) {
	define( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN', 'renden' );
}
...
//----------------------------------------------------------------------------------
	...
	if ( extension_loaded( 'simplexml' ) ) {
		...
		// Add Upgrade Notice
		if( file_exists( get_template_directory() . '/lib/update/update_notice_renden.php' ) )
			require_once( get_template_directory() . '/lib/update/update_notice_renden.php' );
