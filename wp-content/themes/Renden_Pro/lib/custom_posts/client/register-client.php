...
function thinkup_register_clientpost() {
	$labels = array(
		'name'               => _x( 'Clients', 'post type general name', 'renden' ),
		'singular_name'      => _x( 'Client', 'post type singular name', 'renden' ),
		'add_new'            => _x( 'Add New', 'client', 'renden' ),
		'add_new_item'       => __( 'Add New Client', 'renden' ),
		'edit_item'          => __( 'Edit Client', 'renden' ),
		'new_item'           => __( 'New Client', 'renden' ),
		'view_item'          => __( 'View Client', 'renden' ),
		'search_items'       => __( 'Search Clients', 'renden' ),
		'not_found'          => __( 'No clients found', 'renden' ),
		'not_found_in_trash' => __( 'No clients found in Trash', 'renden' ),
		'parent_item_colon'  => '',
		'menu_name'          => __( 'Clients', 'renden' ),
	);
