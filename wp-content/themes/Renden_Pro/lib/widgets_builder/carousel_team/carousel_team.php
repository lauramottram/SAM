...
class thinkup_builder_carouselteam extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('center') . '">Center Align?</label>&nbsp;<input id="' . $this->get_field_id('center') . '" name="' . $this->get_field_name('center') . '" type="checkbox" ' . $center_check . ' style="margin-left: 39px;" /></p>';
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[carousel_team items="' . $items .'" scroll="' . $scroll . '" speed="' . $speed . '" effect="' . $effect . '" show_link="' . $show_link . '" show_name="' . $show_name . '" show_position="' . $show_position . '" show_excerpt="' . $show_excerpt . '" show_social="' . $show_social . '" tag="' . $tag . '" center="' . $center . '" ]' );
