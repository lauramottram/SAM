...
class thinkup_builder_itemteam extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[item_team id="' . $post_id . '" size="' . $size . '" show_link="' . $show_link . '" show_name="' . $show_name . '" show_position="' . $show_position . '" show_excerpt="' . $show_excerpt . '" show_social="' . $show_social . '" center="' . $center . '" ]' );
