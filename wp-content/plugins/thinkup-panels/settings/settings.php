...
class SiteOrigin_Panels_Settings {
	...
	function add_settings_page(){
		$page = add_options_page( __('ThinkUpThemes Page Builder', 'siteorigin-panels'), __('Page Builder', 'siteorigin-panels'), 'manage_options', 'siteorigin_panels', array($this, 'display_settings_page') ); // TUT Customization
