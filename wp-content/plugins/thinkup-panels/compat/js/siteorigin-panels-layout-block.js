( function ( editor, blocks, i18n, element, components, compose ) {
	...
	blocks.registerBlockType( 'siteorigin-panels/layout-block', {
		title: __( 'Layout Builder (in beta)' ), // TUT Customization - Rename builder module title
		
		description: __( "Build a layout using ThinkUpThemes Page Builder." ), // TUT Customization - Rename builder module description
